...
let package = Package(
    ...
    products: [
        .library(
            name: "UnoloIOSSDK",
            targets: ["UnoloIOSSDKWrapper", "FirebaseAuthTarget", "ApolloTarget"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/Unolo/UnoloIOSSDK-dist/releases/download/0.7.0/UnoloIOSSDK.xcframework.zip",
