...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "UnoloIOSSDK",
            url: "https://github.com/Unolo/UnoloIOSSDK-dist/releases/download/1.0.7/UnoloIOSSDK.xcframework.zip",
            checksum: "c00b570b22bbd1084d88568b6e077622d3b9d137e6a7919246c42f76fb6d796c"
        ),
        .binaryTarget(
            name: "UnoloAttendance",
            url: "https://github.com/Unolo/UnoloIOSSDK-dist/releases/download/1.0.7/UnoloAttendance.xcframework.zip",
            checksum: "ddb33e59a196c4c9b0f656aff166c39d0864c9d3f0da5533a5d9292cebfd132b"
        ),
        .binaryTarget(
            name: "UnoloCustomClient",
            url: "https://github.com/Unolo/UnoloIOSSDK-dist/releases/download/1.0.7/UnoloCustomClient.xcframework.zip",
